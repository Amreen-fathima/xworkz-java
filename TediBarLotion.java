class TediBarLotion {
    ...
    TediBarLotion() {
        this(1,"TediBar Lotion",120.0,"TediBar","Sensitive Skin",20,150.5,
        "White","02-02-2025","02-02-2028","Curatio","India","Mild",
        "Bottle","SkinCare","Premium","Available",4,"Nice","Baby Care");
    }

    TediBarLotion(int id,String name,double price,String brand,String skinType,
