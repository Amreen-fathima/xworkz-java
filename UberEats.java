class UberEats {
    ...
    public static double search(String foodName) {
        ...
        else if(foodName == "Brownie Sundae") {
            price = 190.00;
            return price;
        }
        ...
        else if(foodName == "Fish and Chips") {
            price = 300.00;
            return price;
        }
        else if(foodName == "Shrimp Tempura") {
            price = 340.00;
            return price;
        }
        ...
        else if(foodName == "Shawarma Plate") {
            price = 240.00;
            return price;
        }
        ...
        else if(foodName == "Chicken Parmesan") {
            price = 290.00;
            return price;
        }
        else if(foodName == "Minestrone Soup") {
            price = 150.00;
            return price;
        }
        ...
        else if(foodName == "Gelato") {
            price = 160.00;
            return price;
        }
        else if(foodName == "Meatballs") {
            price = 240.00;
            return price;
        }
        ...
        else if(foodName == "Roasted Duck") {
            price = 450.00;
            return price;
        }
        else if(foodName == "Seafood Paella") {
            price = 520.00;
            return price;
        }
        else {
            System.out.println("Food item not available in UberEats");
        }
